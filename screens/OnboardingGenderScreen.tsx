...
export default function OnboardingGenderScreen() {
  ...
  async function handleNext() {
    ...
    if (!selected) {
      Alert.alert("Hold up", "Please pick the option that fits best.");
      return;
    }
    ...
    try {
      ...
      navigation.navigate("OnboardingClassYear");
    } catch (err: any) {
      console.log("OnboardingGender error", err);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subheading}>
        This helps us show better matches. You can change it later.
      </Text>
